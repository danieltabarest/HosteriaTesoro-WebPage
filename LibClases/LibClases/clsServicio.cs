...
namespace LibClases
{
    ...
    {
        #region "Atributos"
        private DropDownList objCboServicio;
        private int iCodigo;
        ...
        public DropDownList ObjCboServicio
        {
            get { return objCboServicio; }
            set { objCboServicio = value; }
        }
        public int ICodigo
        {
            get { return iCodigo; }
        ...
        */
        public bool Grabar()
        {
            if (Validar())
            {
                ...
                //Debemos crear la instrucción SQL
                strSQL = "INSERT INTO [DBHosteria_Tesoro].[dbo].[Servicio]([Descripcion],[Nombre])"+
        ...
        */
        public bool LlenarCombo()
        {
            ...
            if (objCboServicio == null)
            {
                strError = "No definió el combo de empleado";
                return false;
            }
            //Defino la instrucción sql
            strSQL = "SELECT [IdServicio]"+
                        "  ,[Descripcion]"+
                       "   ,[Nombre]"+
                      " FROM [DBHosteria_Tesoro].[dbo].[Servicio]"+
                                              " ORDER BY		Nombre";
            ...
            oCombo.SQL = strSQL;
            oCombo.cboGenericoWeb = objCboServicio;
            oCombo.NombreTabla = "Servicios";
            oCombo.ColumnaTexto = "Nombre";
            oCombo.ColumnaValor = "IdServicio";
            ...
            if (oCombo.LlenarComboWeb())
            {
                ...
                objCboServicio = oCombo.cboGenericoWeb;
                oCombo = null;
                return true;
            }
            else
