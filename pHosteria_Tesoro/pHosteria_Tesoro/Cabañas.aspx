<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Cabañas.aspx.cs" Inherits="pHosteria_Tesoro.WebForm2" %>
            ...
            <table class="style2">
                ...
                <tr>
                    <td class="style5">
                        TARIFA:</td>
                    <td>
                        <asp:DropDownList ID="cboTarifa" runat="server" CssClass="style8" Height="38px" 
                            Width="156px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td class="style5">
                        IMPLEMENTOS:</td>
                    <td>
                        <asp:DropDownList ID="cboImplementos" runat="server" CssClass="style8" 
                ...
                <tr>
                    <td class="style5">
                        SERVICIOS:</td>
                    <td>
                        <asp:DropDownList ID="cboServicios" runat="server" CssClass="style8" 
                            Height="38px" Width="156px">
                        </asp:DropDownList>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="style6">
                        <asp:Button ID="btnGrabar" runat="server" Text="GRABAR" BackColor="#3399FF" 
                            CssClass="style7" onclick="btnGrabar_Click" Width="320px" />
                    </td>
                    <td class="style6">
                        <asp:Button ID="btnLimpiar" runat="server" BackColor="Blue" CssClass="style4" 
                            ForeColor="White" Height="50px" onclick="btnLimpiar_Click" Text="LIMPIAR" 
                            Width="240px" />
                    </td>
                </tr>
                <tr>
