<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Cliente.aspx.cs" Inherits="pHosteria_Tesoro.WebForm6" %>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:ImageButton ID="btnConsultar" runat="server" Height="28px" 
                            ImageUrl="~/Imagenes/Buscar.jpg"  Width="40px" 
                ...
                <tr>
                    <td style="text-align: center">
                        <asp:Button ID="btnGrabar" runat="server" BackColor="Blue" CssClass="style4" 
                            ForeColor="White" Height="50px" Text="GRABAR" 
                            Width="240px" onclick="btnGrabar_Click" />
                    </td>
                    <td style="text-align: center">
